...
public class FruitResource {
  ...
  public Uni<Response> create(Fruit fruit) {
    ...
    if (fruit == null || fruit.id != null) {
      // FruitError error = new FruitError("900", "null is passed");
      throw new WebApplicationException("Id was invalidly set on request.", 422);
    }
    if (fruit == null || fruit.name == null) {
      // FruitError error = new FruitError("900", "null is passed");
      throw new WebApplicationException("Empty request is send.", 422);
    }
    ...
    return Panache.<Fruit>withTransaction(fruit::persist)
        ...
        .onFailure().invoke(f -> System.out.println(f));
  }
  ...
  public Uni<Response> update( Long id, Fruit fruit) {
    if (id == null) {
      throw new WebApplicationException("Empty ID is send", 422);
    }
    if (fruit == null || fruit.id != null) {
      throw new WebApplicationException("Id was invalidly set on request.", 422);
    }
